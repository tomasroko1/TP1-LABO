...
ax.scatter(
    ...
    s=10, color=color_primario, alpha = 0.54, label="Primario"
)
...
ax.set_xlabel('Cantidad de alumnos (Por grupo etario)', fontsize='medium')  
...
# Creamos el layout 2x2 para presentar los gráficos
